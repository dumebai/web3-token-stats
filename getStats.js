...
async function setBurnBalance() {
  let tokenContract = new web3.eth.Contract(liquidityABI, tokenAddress);
...
async function setTotalSupply() {
  let tokenContract = new web3.eth.Contract(liquidityABI, tokenAddress);
              ...
              var WalletTokenBalance = await tokenContract.methods.totalSupply().call();
  ...
  $('#result4').text('$'+Number(marketcap.toFixed(0)).toLocaleString())
}
